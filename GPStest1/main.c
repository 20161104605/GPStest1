...
int main(int argc, const char * argv[]) {
    ...
    fp1=fopen("//Users//fq20161104605//Desktop//GPStest1//GPSTXT.csv","w");
    ...
    printf("UTC时间：%s时%s分%s秒\n",hour,mm,ss);
        fprintf(fp1,"UTC时间：%s时%s分%s秒",hour,mm,ss);
